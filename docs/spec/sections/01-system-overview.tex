  ...
  \item \textbf{Settle:} The effective deltas are routed through the
    ...
    \begin{itemize}
      \item \emph{Loss:} Utilize JT's coverage buffer ($\JTeff$) before ST books
        ...
        loss} (JT's debt to ST). Note that JT IL is a transient debt
        obligation that only materially exists during the market's
        configured fixed-term regime: a period of time that allows the
        tranched asset to recover before the junior tranche realizes
        any losses.
...
precise in \cref{sec:existence}, exactly one value of
