...
\begin{enumerate}
  ...
  \item \textbf{Attribute:} Past coverage and risk premiums can leave a
    ...
    claim on the \emph{other} tranche's holdings. Each side's raw NAV delta is
...
\begin{enumerate}
  \item \textbf{NAV conservation:} the inputs sum to the outputs,
    ...
    itself a prior output of $F$. $F$ only redistributes value between the tranches. It never
