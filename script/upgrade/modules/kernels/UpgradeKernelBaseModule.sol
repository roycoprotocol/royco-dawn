...
///         but not on `IRoycoDawnKernel`. Avoids importing the full `RoycoKernel` here.
 ...
 * @notice Abstract base for `RoycoKernel`-family upgrades. Concrete subclasses (one per kernel
