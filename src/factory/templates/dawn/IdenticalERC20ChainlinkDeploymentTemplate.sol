...
import { COMPONENT_ID_KERNEL_IDENTICAL_ERC20_CHAINLINK } from "../Components.sol";
import { DawnDeploymentTemplate } from "./base/DawnDeploymentTemplate.sol";

/// @notice Deployment template for `Identical_ERC20_ST_JT_ChainlinkToAdminOracle_Kernel` markets.
contract IdenticalERC20ChainlinkDeploymentTemplate is DawnDeploymentTemplate {
    struct KernelParams {
    ...
    function _kernelComponentId() internal pure override returns (bytes32) {
        return COMPONENT_ID_KERNEL_IDENTICAL_ERC20_CHAINLINK;
    }
