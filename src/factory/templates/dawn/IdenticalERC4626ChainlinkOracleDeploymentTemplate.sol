...
import { Identical_ERC4626_ST_JT_SharePriceToChainlinkOracle_Kernel } from "../../../kernels/dawn/Identical_ERC4626_ST_JT_SharePriceToChainlinkOracle_Kernel.sol";
import { COMPONENT_ID_KERNEL_IDENTICAL_ERC4626_CHAINLINK_ORACLE } from "../Components.sol";
import { DawnDeploymentTemplate } from "./base/DawnDeploymentTemplate.sol";

/// @notice Deployment template for `Identical_ERC4626_ST_JT_SharePriceToChainlinkOracle_Kernel` markets.
contract IdenticalERC4626ChainlinkOracleDeploymentTemplate is DawnDeploymentTemplate {
    struct KernelParams {
    ...
    function _kernelComponentId() internal pure override returns (bytes32) {
        return COMPONENT_ID_KERNEL_IDENTICAL_ERC4626_CHAINLINK_ORACLE;
    }
