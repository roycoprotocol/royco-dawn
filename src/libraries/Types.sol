 ...
 *      - The market is healthy (no losses over dust tolerance) or it is severely undercollateralized (liquidation utilization breach) or uncollateralized (JT_EFFECTIVE_NAV == 0)
...
struct SyncedAccountingState {
    ...
    // The market's marked-to-market NAVs, JT coverage impermanent loss, and fees
    NAV_UNIT stRawNAV;
    NAV_UNIT jtRawNAV;
 ...
 *                            that attribute those deltas, and its effective NAVs and JT coverage impermanent loss seed the settlement's opening balances
 ...
 * @custom:field postPnLWaterfallCheckpoint - The checkpoint output by the PnL waterfall: the current raw NAVs alongside the settled effective NAVs and JT coverage impermanent loss
